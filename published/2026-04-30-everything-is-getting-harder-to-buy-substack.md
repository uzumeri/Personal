...
# Everything Is Getting Harder to Buy

### Technology is simplifying consumer purchases — and simultaneously making business-to-business transactions so complex that entire markets are thinning out

![Hero Image](images/2026-04-30-everything-is-getting-harder-to-buy-hero.webp)
...
The optimistic reading is that AI and modern information tools might be able to do for B2B what the last generation of platforms did for B2C — not by making products simpler, but by making the *transaction* simpler even as the product grows more complex. Semantic matching across different vocabularies. Automated evaluation of specifications against requirements. Trust signals aggregated from verified transaction histories. Regulatory mapping across jurisdictions. These are all problems that benefit from the same AI capabilities that are driving product complexity in the first place.
...
*What's your experience with this? If you work in procurement, trade, or any specialized market — are you seeing the same pattern? I'd love to hear your take in the comments.*
...
**Substack Tags:** market-design, technology, strategy, ai
